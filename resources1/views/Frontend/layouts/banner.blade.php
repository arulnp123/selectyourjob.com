         ...
         <div class="auto-container">
            <div class="row">
               ...
               <div class="image-column col-lg-5 col-md-12">
                  <div class="image-box">
                     <figure class="main-image wow fadeIn" data-wow-delay="500ms"><img src="{{ URL::to('/') }}/assets/images/resource/banner-img-1.png" alt=""></figure>
                     ...
                     <div class="info_block_two anm wow fadeIn" data-wow-delay="2000ms" data-speed-x="1" data-speed-y="1">
                        <p>10k+ Candidates</p>
                        <div class="image"><img src="{{ URL::to('/') }}/assets/images/resource/multi-peoples.png" alt=""></div>
                     </div>
