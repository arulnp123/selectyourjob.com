            ...
            <div class="ls-widget">
              <div class="tabs-box">
                ...
                <div class="widget-content">
                  ...
                  <form action="http://127.0.0.1:8000/updatejob_post" method="post" class="default-form" enctype="multi" > 
                  {{ csrf_field() }}
                  @foreach($edit_job_post as $editjob)
                    <div class="row">
                      ...
                      <div class="form-group col-lg-4 col-md-12">
                        <label>status</label>
                        <select class="chosen-select"name="status" type="text" value="{{ $editjob->status }}"  placeholder="status">
