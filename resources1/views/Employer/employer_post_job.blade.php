                    ...
                    <div class="ls-widget">
                        <div class="tabs-box">
                            ...
                            <div class="widget-content">
                                ...
                                <form class="default-form" action="{{ url('/employer_post_jobs') }}" method="post">
                                    {{ csrf_field() }}
                                    <div class="row">
                                        <!-- Input -->
                                        ...
                                        <div class="form-group col-lg-6 col-md-12">
                                            ...
                                            <input type="text" name="clocat" @required(true)
                                        ...
                                        <div class="form-group col-lg-6 col-md-12">
                                            ...
                                            <select name="jlocat" type="text" @required(true)
                                        ...
                                        <div class="form-group col-lg-6 col-md-12">
                                            ...
                                            <select class="chosen-select"name="jtype" type="text" @required(true)
                                        ...
                                        <div class="form-group col-lg-6 col-md-12">
                                            ...
                                            <select name="jcateg" type="text" @required(true)
                                                placeholder="job category">
                                        ...
                                        <div class="form-group col-lg-6 col-md-12">
                                            ...
                                            <input type="text" name="skillneed" @required(true)
                                                placeholder="php,java,html,.................">
                                        </div>
                                        ...
                                        <div class="form-group col-lg-4 col-md-12">
                                            <label>Gender</label>
                                            <select class="chosen-select"name="gend" type="text" @required(true)
                                                placeholder="gender">
                                        ...
                                        <div class="form-group col-lg-4 col-md-12">
                                            ...
                                            <input type="text" name="posavail" @required(true)
                                        ...
                                        <div class="form-group col-lg-4 col-md-12">
                                            ...
                                            <input type="text" name="deadline" @required(true)
                                        ...
                                        <div class="form-group col-lg-6 col-md-12">
                                            ...
                                            <input type="text" name="webs" @required(true)
                                                placeholder="Websites name">
                                        </div>

                                        <div class="form-group col-lg-6 col-md-12">
                                            <label>Job Sector</label>

                                            <select name="jobsec" type="text" @required(true)
                                        ...
                                        <div class="form-group col-lg-6 col-md-12">
                                            ...
                                            <select name="induistr" type="text" @required(true)
                                                placeholder="industry">
                                                <option value="" disabled selected>Select Industry</option>
                                                @foreach ($industries as $indust)
                                                    <option value="{{ $indust->industries_name }}">
                                                        {{ $indust->industries_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group col-lg-6 col-md-12">
                                            <label>Country</label>
                                            <select class="chosen-select"name="count" type="text" @required(true)
                                                placeholder="Country">
                                        ...
                                        <div class="form-group col-lg-12 col-md-12">
                                            ...
                                            <input type="text" name="caddres" @required(true)
                                                placeholder="Address">
                                        </div>
                                        <!-- Input -->
