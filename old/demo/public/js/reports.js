...
$(document).ready(function(){
    ...
    $("#confirmLdgSlip").click(function(){
 ...
 
        {
            ...
            for(var i = 0; i < selectedItemNodeLength; i++){
                ...
                var ldgSlipName = $("#txtLdgName").val();
                //var ldgSlipPrjName = projectID;
                
               
                    
                    //then prepare data to add to array of items' info
                    var itemInfo = {_iC:itemCode, _ldgDesc:ldgSlipName};
    ...
    $("#hidePkgForm").click(function(){
        ...
        //change main "new loading" button back to default
        $("#showPkgForm").html("<i class='fa fa-plus'></i> New Loading Slip");
    });
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //TO SHOW/HIDE THE TRANSACTION FORM
    $("#showStkForm").click(function(){
        debugger;
        $("#currStock").toggleClass('collapse');
        
        if($("#currStock").hasClass('collapse')){
            $(this).html("<i class='fa fa-plus'></i> Current Stock Report");
        }
        
        else{
            $(this).html("<i class='fa fa-minus'></i> Current Stock Report");
    ...
    $("#hideStkForm").click(function(){
        ...
        //change main "new loading" button back to default
        $("#showStkForm").html("<i class='fa fa-plus'></i> Current Stock Report");
    });
    ...
    $("#clickToGenPkg").click(function(e){
        e.preventDefault();
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //WHEN "GENERATE REPORT" BUTTON IS CLICKED FROM THE MODAL
    $("#clickToGenLdg").click(function(e){
        e.preventDefault();
 ...
 $("#getCurrentStock").click(function(e){
        e.preventDefault();
        ...
        window.open(appRoot+"items/report/"+projectID, 'Print', strWindowFeatures);
    });
...
function selectedItem(selectedNode){
    ...
    if(selectedNode){
        ...
        // var itemCbtNameElem = selectedNode.parentNode.parentNode.children[2].children[1];
        var itemAvailQtyElem = selectedNode.parentNode.parentNode.children[2].children[1];
