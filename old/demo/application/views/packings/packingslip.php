...
?>
<div id="pkgSlipToPrint" style="font-size:14px;">

     <div class="row" style="margin-top:2px">
        <div class="col-sm-6">
            <img src="<?=base_url().CMP_domain?>public/images/logo_10.jpg" alt="logo" class="img-responsive" width="130">
        </div>
    ...
    $pkgid = "";
     foreach($allTransInfo as $get):$pkgid ='VK'.substr(sprintf('%04d', $get['id']),0,5); ?>
        <div class="row">
            ...
            <div class="col-xs-5"><?=ellipsize($get['cabinetName'], 20);?></div>
            <div class="col-xs-5"><?=ellipsize($get['partName'], 20);?></div>
