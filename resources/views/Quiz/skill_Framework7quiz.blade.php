...
@section('content')
@include('Quiz/layouts.sidebar_Framework')
...
<header class="header bg-primary">
        <div class="title">
            <div class="timer">
                <div class="time_left_txt" style="color : white;">Time Left: <span id="timer">30:00</span></div>
            ...
            <script>
                ...
                startTimer();
                document.getElementById("Question-number").innerText = "Question "+currentQuestion+"/"+totalQuestions;
                ...
                function nextQuestion() {
                    ...
                    if (currentQuestion > totalQuestions) {
                        ...
                        startTimer();
                        const currentQuestionData = quiz.JS[currentQuestion - 1];
                        document.getElementById('question').innerText = currentQuestionData.question;
                        $('input[name=option]').prop('checked', false);
                        const optionsContainer = document.getElementById('question-options');
        optionsContainer.innerHTML = ""; 

        currentQuestionData.options[0].forEach((option, index) => {
            const optionElement = document.createElement('div');
            optionElement.classList.add('form-check', 'option-block');
            optionElement.innerHTML = `
            <label class='form-check-label'>
            <input type='radio' class='form-check-input' name='option' id='q${index}' value='${option}'>
...
<div style="margin-top : -15px;" class="right-title">Total Questions: <span id="tque"></span>
<div id="Question-number">Question 1</div></div>
            ...
            <div class="col-sm-12">
                <div id="result" class="quiz-body">
                    <form name="quizForm" onSubmit="">
                        ...
                        <button name="previous" id="previous" class="btn btn-success" onclick="prevQuestion()">Previous</button>
                        &nbsp;
                        <button name="next" id="next" class="btn btn-success" onclick="nextQuestion()">Next</button>
                    </form>
                </div>
            </div> 
        </div> 
