...
Route::get('/php_skill', [App\Http\Controllers\Quiz\QuizController::class, 'php_skill'])->name('php_skill');

Route::get('/skill_phphome', [App\Http\Controllers\Quiz\QuizController::class, 'skill_phphome'])->name('skill_phphome');

Route::get('/skill_phpquiz', [App\Http\Controllers\Quiz\QuizController::class, 'skill_phpquiz'])->name('skill_phpquiz');

Route::get('/skill_javahome', [App\Http\Controllers\Quiz\QuizController::class, 'skill_javahome'])->name('skill_javahome');

Route::get('/skill_javaquiz', [App\Http\Controllers\Quiz\QuizController::class, 'skill_javaquiz'])->name('skill_javaquiz');


Route::get('/skill_pythonhome', [App\Http\Controllers\Quiz\QuizController::class, 'skill_pythonhome'])->name('skill_pythonhome');

Route::get('/skill_pythonquiz', [App\Http\Controllers\Quiz\QuizController::class, 'skill_pythonquiz'])->name('skill_pythonquiz');

Route::get('/skill_pyspokehome', [App\Http\Controllers\Quiz\QuizController::class, 'skill_pyspokehome'])->name('skill_pyspokehome');

Route::get('/skill_pyspokequiz', [App\Http\Controllers\Quiz\QuizController::class, 'skill_pyspokequiz'])->name('skill_pyspokequiz');

Route::get('/skill_Sqlhome', [App\Http\Controllers\Quiz\QuizController::class, 'skill_Sqlhome'])->name('skill_Sqlhome');

Route::get('/skill_Sqlquiz', [App\Http\Controllers\Quiz\QuizController::class, 'skill_Sqlquiz'])->name('skill_Sqlquiz');

Route::get('/skill_Oraclehome', [App\Http\Controllers\Quiz\QuizController::class, 'skill_Oraclehome'])->name('skill_Oraclehome');

Route::get('/skill_Oraclequiz', [App\Http\Controllers\Quiz\QuizController::class, 'skill_Oraclequiz'])->name('skill_Oraclequiz');


Route::get('/skill_Snowflexhome', [App\Http\Controllers\Quiz\QuizController::class, 'skill_Snowflexhome'])->name('skill_Snowflexhome');

Route::get('/skill_Snowflexquiz', [App\Http\Controllers\Quiz\QuizController::class, 'skill_Snowflexquiz'])->name('skill_Snowflexquiz');


Route::get('/skill_NoSqlhome', [App\Http\Controllers\Quiz\QuizController::class, 'skill_NoSqlhome'])->name('skill_NoSqlhome');

Route::get('/skillNosql_quiz', [App\Http\Controllers\Quiz\QuizController::class, 'skillNosql_quiz'])->name('skillNosql_quiz');


Route::get('/skill_Htmlquiz', [App\Http\Controllers\Quiz\QuizController::class, 'skill_Htmlquiz'])->name('skill_Htmlquiz');

Route::get('/skill_Htmlhome', [App\Http\Controllers\Quiz\QuizController::class, 'skill_Htmlhome'])->name('skill_Htmlhome');


Route::get('/skill_Cssquiz', [App\Http\Controllers\Quiz\QuizController::class, 'skill_Cssquiz'])->name('skill_Cssquiz');

Route::get('/skill_Csshome', [App\Http\Controllers\Quiz\QuizController::class, 'skill_Csshome'])->name('skill_Csshome');


Route::get('/skill_Angularquiz', [App\Http\Controllers\Quiz\QuizController::class, 'skill_Angularquiz'])->name('skill_Angularquiz');

Route::get('/skill_Angularhome', [App\Http\Controllers\Quiz\QuizController::class, 'skill_Angularhome'])->name('skill_Angularhome');


Route::get('/skill_Reactquiz', [App\Http\Controllers\Quiz\QuizController::class, 'skill_Reactquiz'])->name('skill_Reactquiz');

Route::get('/skill_Reacthome', [App\Http\Controllers\Quiz\QuizController::class, 'skill_Reacthome'])->name('skill_Reacthome');


Route::get('/skill_Androidhome', [App\Http\Controllers\Quiz\QuizController::class, 'skill_Androidhome'])->name('skill_Androidhome');

Route::get('/skill_Androidquiz', [App\Http\Controllers\Quiz\QuizController::class, 'skill_Androidquiz'])->name('skill_Androidquiz');


Route::get('/skill_Flutterhome', [App\Http\Controllers\Quiz\QuizController::class, 'skill_Flutterhome'])->name('skill_Flutterhome');

Route::get('/skill_Flutterquiz', [App\Http\Controllers\Quiz\QuizController::class, 'skill_Flutterquiz'])->name('skill_Flutterquiz');


Route::get('/skill_Framework7home', [App\Http\Controllers\Quiz\QuizController::class, 'skill_Framework7home'])->name('skill_Framework7home');

Route::get('/skill_Framework7quiz', [App\Http\Controllers\Quiz\QuizController::class, 'skill_Framework7quiz'])->name('skill_Framework7quiz');


Route::get('/skill_Xamarinhome', [App\Http\Controllers\Quiz\QuizController::class, 'skill_Xamarinhome'])->name('skill_Xamarinhome');

Route::get('/skill_Xamarinquiz', [App\Http\Controllers\Quiz\QuizController::class, 'skill_Xamarinquiz'])->name('skill_Xamarinquiz');
